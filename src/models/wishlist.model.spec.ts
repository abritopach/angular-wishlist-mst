...
import { MatchesSnapshot, expectjs, registerSnapshots } from 'jasmine-snapshot';

describe('WishList Model', () => {

    /*
    const snapshotList = Object {
        items: [{
    ...
    beforeAll(() => {
        ...
        registerSnapshots(snapshotList as any, 'snapshot list');
    });
    */
    ...
    it('should add new item to WishList', () => {
        ...
        */
        ...
        // jasmine-snapshot.
        // expectjs(getSnapshot(list)).toMatchSnapshot();
        // expectjs(states).toMatchSnapshot();
    ...
    it('should add new item to WishList 2', () => {
        ...
        onPatch(list, patch => {
            patches.push(patch);
            // registerSnapshots(patches as any, 'patches');
        });
        list.add({
            name: 'Chesterton',
            price: 10
        ...
        // expectjs(patches).toMatchSnapshot();
    });
